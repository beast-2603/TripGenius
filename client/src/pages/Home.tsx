...
const Home = () => {
  ...
  const destinations = [
    {
      imageUrl:
        'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80',
      title: 'Paris, France',
      description: 'Romance, culture, and cuisine'
    },
    {
      imageUrl:
        'https://images.unsplash.com/photo-1513581166391-887a96ddeafd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80',
      title: 'Bali, Indonesia',
      description: 'Tropical paradise and spiritual retreats'
    },
    {
      imageUrl:
        'https://images.unsplash.com/photo-1505761671935-60b3a7427bad?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80',
      title: 'New York, USA',
      description: 'Urban adventure in the city that never sleeps'
    },
    {
      imageUrl:
        'https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80',
      title: 'Costa Rica',
      description: 'Adventure and eco-tourism paradise'
    },
    {
      imageUrl:
        'https://images.unsplash.com/photo-1513407030348-c983a97b98d8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80',
      title: 'Tokyo, Japan',
      description: 'Blend of tradition and futuristic technology'
    },
    {
      imageUrl:
        'https://images.unsplash.com/photo-1523592121529-f6dde35f079e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80',
  ...
  const features = [
    {
      ...
      description:
        'Get a complete trip itinerary in seconds, not hours. No more endless research.'
    },
    {
      icon: MessageSquare,
      title: 'Personalized Recommendations',
      description:
        'AI tailors suggestions based on your preferences, budget, and travel style.'
    },
    {
      icon: Users,
      title: 'Group Friendly',
      description:
        'Plan for solo trips, couples, or large groups with diverse interests.'
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'Our AI combines data from millions of travelers, local insights, and travel expertise to create personalized itineraries based on your preferences, budget, and travel style.'
    },
    {
      question: 'When will TripGenius launch?',
      answer:
        "We're currently in final beta testing and expect to launch in the next 2-3 months. Create an account today to be among the first to get access!"
    },
    {
      question: 'Is TripGenius free to use?',
      answer:
        'TripGenius will offer both free and premium plans. Free users can generate basic itineraries, while premium subscribers get additional features like offline access, priority support, and more detailed recommendations.'
    },
    {
      question: 'Can I book directly through TripGenius?',
      answer:
        "While we don't currently offer direct booking, we provide links to trusted booking platforms for each recommendation in your itinerary. We're working on adding direct booking in future updates."
    }
  ];
    ...
    <div className="min-h-screen font-sans text-gray-900 bg-gradient-to-b from-white to-blue-50">
      ...
      <div className="relative bg-gray-900">
        <div className="absolute inset-0">
          ...
          />
          <div
            className="absolute inset-0 bg-gray-900 bg-opacity-70 mix-blend-multiply"
            aria-hidden="true"
          ></div>
        </div>
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8 text-center">
          ...
          <p
            ...
            data-aos-delay="200"
          >
            Stop spending hours planning your vacation. Let our AI craft the
            perfect personalized itinerary in seconds.
          </p>
          <div
          ...
          >
            <div className="space-y-4 sm:space-y-0 sm:inline-grid sm:grid-cols-2 sm:gap-5">
              ...
              <a href="#how-it-works">
                <Button
                  variant="outline"
                  className="flex w-full text-white bg-gray-800 bg-opacity-60 hover:bg-opacity-70 border-gray-700"
                >
                  Learn more
                </Button>
              </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p
              ...
              data-aos-delay="200"
            >
              Our AI-powered platform creates custom itineraries tailored to
              your preferences.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
              Explore these stunning destinations with personalized itineraries
              from TripGenius.
            </p>
          </div>
      ...
      <div id="trip-planner" className="py-16 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
              Experience the power of AI trip planning before we launch. Create
              an account for early access.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p
              ...
              data-aos-delay="200"
            >
              Our AI handles the complex planning so you can focus on enjoying
              your journey.
            </p>
          </div>
          ...
          <div className="mt-12 max-w-lg mx-auto grid gap-10 lg:grid-cols-3 lg:max-w-none">
            ...
            >
              <div className="flex-shrink-0">
                <div className="flex items-center justify-center h-16 w-16 rounded-full bg-gradient-to-br from-blue-600 to-indigo-600 text-white text-2xl font-bold shadow-md">
                  1
                </div>
              </div>
              <div className="mt-6">
                ...
                <p className="mt-3 text-base text-gray-500">
                  Enter your destination, budget, trip type, and other details
                  to help our AI understand what you're looking for.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="mt-6">
                <h3 className="text-xl font-medium text-gray-900">
                  Our AI creates your itinerary
                </h3>
                <p className="mt-3 text-base text-gray-500">
                  Within seconds, our advanced AI analyzes thousands of options
                  to create a personalized day-by-day plan.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="mt-6">
                ...
                <p className="mt-3 text-base text-gray-500">
                  Download your itinerary, share it with travel companions, and
                  make the most of your perfectly planned vacation.
                </p>
              </div>
            </div>
          </div>
      ...
      <div id="testimonials" className="py-16 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
              Join these happy travelers by creating an account for early
              access.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p
              ...
              data-aos-delay="200"
            >
              Everything you need to know about TripGenius before creating an
              account.
            </p>
          </div>
          ...
          >
            ...
            <div className="ml-3 inline-flex rounded-md shadow">
              <a href="#how-it-works">
                <Button
                  variant="outline"
                  className="text-white bg-primary border-white bg-opacity-60 hover:bg-opacity-70"
                >
                  Learn more
                </Button>
              </a>
